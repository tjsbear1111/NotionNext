...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，您想瞭解日本防衛,Hi，您想獲取最快資訊,Hi，您想學習專業用語,歡迎來到我的部落格🎉',
  ...
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'JPDF, 部落格', // 网站关键词 英文逗号隔开
